...
static void PrintQuery(const vector<hw3::QueryProcessor::QueryResult>&);
...
int main(int argc, char** argv) {
  ...
  hw3::QueryProcessor qp(index_list, true);
  while (1) {
...
static void PrintQuery(const vector<hw3::QueryProcessor::QueryResult> &result) {
  if (result.size() == 0)
